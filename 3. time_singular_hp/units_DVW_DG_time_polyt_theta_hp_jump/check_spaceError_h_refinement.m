...
for i=1 :length(NO_elem_vec)    
     ...
     load(['Error of ' num2str(NO_elem_vec(i)) ' rectangle space Elements with ' Basis_Type num2str(S_Polydegree_vec(k)) ' space basis, combining '...
...
slope_Poly(k) = mean(slope_P1(end));%%k阶多项式在最后一个时间步的斜率
%{
...
legend([ Basis_Type  num2str(S_Polydegree_vec(1)) ' and ' num2str(Time_Steps) ' geometrical time steps with slope ' num2str(slope_Poly(1))],...
       'Location','SouthWest')      
