...
gf_vec = [0.15,0.25,0.3,0.4,0.45];     % temporal mesh grading factor of 
mu_vec = [1,1.5,1.75,2,2.5];  % polynomial degree increasing factor
...
for OB = 1: length(gf_vec)
for OA = 1: length(mu_vec) 
mu = mu_vec(OA);
gf = gf_vec(OB);
...
switch  Basis_Type
     case 'P'
loglog(dof_P.^a,err_P(:,1),[num2str(shape{OB}) num2str(color{OA})],'LineWidth',1.5,'MarkerSize',10);
     case 'PQ'
loglog(dof_P.^a,err_P(:,1),[num2str(shape{OB}) num2str(color{OA})],'LineWidth',1.5,'MarkerSize',10);
     case 'Q'
semilogy(dof_P.^a,err_P(:,1),[num2str(shape{OB}) num2str(color{OA})],'LineWidth',1.5,'MarkerSize',10);
end
...
legend([ '\sigma = ' num2str(gf_vec(1)) ', \mu = ' num2str(mu_vec(1)) ],...
       [ '\sigma = ' num2str(gf_vec(1)) ', \mu = ' num2str(mu_vec(2)) ],...
       [ '\sigma = ' num2str(gf_vec(1)) ', \mu = ' num2str(mu_vec(3)) ],...
       [ '\sigma = ' num2str(gf_vec(1)) ', \mu = ' num2str(mu_vec(4)) ],... 
       [ '\sigma = ' num2str(gf_vec(1)) ', \mu = ' num2str(mu_vec(5)) ],...    
       [ '\sigma = ' num2str(gf_vec(2)) ', \mu = ' num2str(mu_vec(1)) ],...
       [ '\sigma = ' num2str(gf_vec(2)) ', \mu = ' num2str(mu_vec(2)) ],...
       [ '\sigma = ' num2str(gf_vec(2)) ', \mu = ' num2str(mu_vec(3)) ],...
       [ '\sigma = ' num2str(gf_vec(2)) ', \mu = ' num2str(mu_vec(4)) ],...
       [ '\sigma = ' num2str(gf_vec(2)) ', \mu = ' num2str(mu_vec(5)) ],...
       [ '\sigma = ' num2str(gf_vec(3)) ',   \mu = ' num2str(mu_vec(1)) ],...
       [ '\sigma = ' num2str(gf_vec(3)) ',   \mu = ' num2str(mu_vec(2)) ],...
       [ '\sigma = ' num2str(gf_vec(3)) ',   \mu = ' num2str(mu_vec(3)) ],...
       [ '\sigma = ' num2str(gf_vec(3)) ',   \mu = ' num2str(mu_vec(4)) ],...
       [ '\sigma = ' num2str(gf_vec(3)) ',   \mu = ' num2str(mu_vec(5)) ],...
       [ '\sigma = ' num2str(gf_vec(4)) ',   \mu = ' num2str(mu_vec(1)) ],...
       [ '\sigma = ' num2str(gf_vec(4)) ',   \mu = ' num2str(mu_vec(2)) ],...
       [ '\sigma = ' num2str(gf_vec(4)) ',   \mu = ' num2str(mu_vec(3)) ],...
       [ '\sigma = ' num2str(gf_vec(4)) ',   \mu = ' num2str(mu_vec(4)) ],...
       [ '\sigma = ' num2str(gf_vec(4)) ',   \mu = ' num2str(mu_vec(5)) ],...
       [ '\sigma = ' num2str(gf_vec(5)) ', \mu = ' num2str(mu_vec(1)) ],...
       [ '\sigma = ' num2str(gf_vec(5)) ', \mu = ' num2str(mu_vec(2)) ],...
       [ '\sigma = ' num2str(gf_vec(5)) ', \mu = ' num2str(mu_vec(3)) ],...
       [ '\sigma = ' num2str(gf_vec(5)) ', \mu = ' num2str(mu_vec(4)) ],...
       [ '\sigma = ' num2str(gf_vec(5)) ', \mu = ' num2str(mu_vec(5)) ],...
   'Location','NorthEast','NumColumnsMode','manual','NumColumns',1)    
xlabel(' Dof^{1/2} ','FontSize',8,'visible','on');
...
switch  Norm_type
     ...
     case 'L_inf_grad'
        ...
        title('$L^{\infty}(I;H^1(\Omega))$ norm error under $hp$-refinement','FontSize',18,'interpreter','LaTex');        
     case 'L_inf_H1'
        ylabel('|| u-u_{h}||_{L^\infty((0,T),L^2(\Omega))}','FontSize',18);        
     ...
     case 'H1_H1'    
        ...
        title('$H^1(I;H^1(\Omega))$ norm error under $hp$-refinement','FontSize',18,'interpreter','LaTex'); 
     case 'W_1_inf_L2'
        ylabel('$||e||_{W^{1,\infty}(I;L^2(\Omega))}$','FontSize',18,'interpreter','LaTex');       
        title('$W^{1,\infty}(I;L^2(\Omega))$ norm error under $hp$-refinement','FontSize',18,'interpreter','LaTex');   
     case 'W1_inf_grad'
     ...
     case 'Energynorm'    
        ...
        title('DG norm error under $hp$-refinement','FontSize',18,'interpreter','LaTex'); 
     end
