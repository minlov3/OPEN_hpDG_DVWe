...
for i=1 :length(NO_time_step_vec)    
     load([num2str(eta(et)) ' Error of ' num2str(NO_elem) ' rectangle space Elements combine ' num2str(NO_time_step_vec(i)) ' time elements with space basis '...
...
format shortE
legend(['\zeta='  num2str(eta(1),'%0.e') ' slope ' num2str(-slope_Poly(1))],...
       'Location','SouthWest')      
