...
errL_2 =NaN(length(S_Polydegree_vec),1); 
dof = NaN(length(S_Polydegree_vec),1);
...
case 'Se'
semilogy(dof.^(1/3),errL_2,'-go','LineWidth',1,'MarkerSize',8);
end
...
title('space p refinement','FontSize',18); set(gca,'FontSize',15);
