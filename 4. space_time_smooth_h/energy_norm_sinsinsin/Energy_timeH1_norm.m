function [H1_L2_part,H1_grad_part,H1_H1_part ] = Energy_timeH1_norm(Space_Node,Time_Node,BDbox , coef ,S_Po,T_Po  ,FEM_index,u,grad_u,grad_ut,a,gamma,eta)
...
%%Calculating the DG norm error based on the old way
 ...
 % data for quadrature
    ...
    grad_ut_DG = [Qx*coef , Qy*coef, Qz*coef];   %gradient of time derivative of DG
     ...
     t3 = sum((gradt).*eta_val,2);  
     H1_grad_part =  dot((t3),weights);%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
