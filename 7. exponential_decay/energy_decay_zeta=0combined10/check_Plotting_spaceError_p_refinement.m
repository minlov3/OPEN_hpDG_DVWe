...
for i= 1:length(S_Polydegree_vec)    
     load(['Error of ' num2str(NO_elem_vec(k)) ' rectangle space Elements combine ' num2str(NO_time_step) ' time elements with space basis '...
            Basis_Type num2str(S_Polydegree_vec(i)) ' and time basis ' num2str(T_Polydegree) ' basis.mat'])
...
legend([ num2str(NO_elem_vec(1))   ' FEM rect ' Basis_Type   ],...
       'Location','SouthWest')      
