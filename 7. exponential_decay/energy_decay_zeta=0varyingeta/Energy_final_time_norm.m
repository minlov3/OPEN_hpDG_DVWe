function [Final_t_L2_L2_part,Final_t_L2_grad_part, Final_t_L2_H1_part,...
        ...
        = Energy_final_time_norm(Space_Node,Time_Node,BDbox , coef ,S_Po,T_Po  ,FEM_index,u,grad_u,grad_ut,a,zeta)
...
%%Calculating the DG norm error based on the old way
 ...
 % data for quadrature
    ...
    grad_ut_DG = [Qx*coef , Qy*coef, Qz*coef];
     ...
     Final_t_L2_grad_part  = dot((t2),weights);%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
     Final_t_L2_H1_part = Final_t_L2_grad_part + Final_t_L2_L2_part ;%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
     Final_t_H1_L2_part = dot( grad(:,9),weights);%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
     
     % L2 norm of the H_1 semi-norm    
     grad11 = 0 - grad_ut_DG;    grad21 = 0 - grad_ut_DG;
     ...
     t3 = sum((grad0).*a_val,2);   
     Final_t_H1_grad_part  = dot((t3),weights);%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
