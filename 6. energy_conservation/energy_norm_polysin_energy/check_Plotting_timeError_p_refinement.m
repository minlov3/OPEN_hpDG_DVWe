...
T_Polydegree_vec = [1,2,3,4,5,6,7];
a=1; %%%%% Dof^{a}
...
slope_Poly(k) = mean(slope_P1(end-4:end));
...
legend([ num2str(NO_time_step_vec(1)) '  ' ' time steps  ' ],...
       [ num2str(NO_time_step_vec(2)) ' time steps '],...
       'Location','SouthWest')      
...
switch  Norm_type
     ...
     case 'L_inf_grad'
        ...
        title('$L^{\infty}((I;H^1(\Omega))$ norm error under $p$-refinement','FontSize',18,'interpreter','LaTex')        
     case 'L_inf_H1'
    ...
    case 'H1_grad'
     ...
     case 'H1_H1'    
        ...
        title('$H^1(I;H^1(\Omega))$ norm error under $p$-refinement','FontSize',18,'interpreter','LaTex')
     case 'W_1_inf_L2'
        ylabel('$||e||_{W^{1,\infty}(I;L^2(\Omega))}$','FontSize',25,'interpreter','LaTex');       
        title('$W^{1,\infty}(I;L^2(\Omega))$ norm error under $p$-refinement','FontSize',18,'interpreter','LaTex')   
     case 'W_1_inf_grad'
     ...
     case 'Final_t_L2_grad'
        ...
        title('$||\nabla e(T)||_{L^2(\Omega))}$ error under $p$-refinement','FontSize',18,'interpreter','LaTex')          
     case 'Final t_L2_H1'    
        ylabel('$||\nabla e(T)||_{L^2(\Omega))}$','FontSize',18,'interpreter','LaTex')        
        title('$||\nabla e(T)||_{L^2(\Omega))}$ norm error under $p$-refinement','FontSize',18,'interpreter','LaTex')     
     case 'Final_t_H1_L2'
        ylabel('$||\dot{e}(T)||_{L^2(\Omega))}$','FontSize',18,'interpreter','LaTex') 
        title('$||\dot{e}(T)||_{L^2(\Omega))}$ error under $p$-refinement','FontSize',18,'interpreter','LaTex') 
     case 'Final_t_H1_grad'
     ...
     case 'Energynorm'    
        ylabel('$||e||_{\mathrm{DG}}$','FontSize',25,'interpreter','LaTex');        
        title('DG norm error under $p$-refinement','FontSize',18,'interpreter','LaTex')         
end
