function [L_inf_L2_part,L_inf_grad_part,L_inf_H1_part] = Err_timeL_inf_norm(Space_Node,Time_Node,BDbox , coef ,S_Po,T_Po  ,FEM_index,u,   grad_u,a,zeta)
...
%%Calculating the DG norm error based on the old way
 ...
 % data for quadrature
    ...
    grad_u_DG = [Px*coef , Py*coef, Pz*coef];   %gradient of DG
     ...
     L_inf_grad_part(k) = dot((t3),weights);%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
