...
NO_time_step_vec = [2,4,8,16,32,64,128,256,512,1024];
...
slope_Poly(k) = mean(slope_P1(end)); 
elseif k==4
slope_Poly(k) = mean(slope_P1(end-1));
end
...
legend(['q='  num2str(T_Polydegree_vec(1)) ' slope ' num2str(-slope_Poly(1))],...
       ['q='  num2str(T_Polydegree_vec(2)) ' slope ' num2str(-slope_Poly(2))],...
       ['q='  num2str(T_Polydegree_vec(3)) ' slope ' num2str(-slope_Poly(3))],...
       ['q='  num2str(T_Polydegree_vec(4)) ' slope ' num2str(-slope_Poly(4))],...
       'Location','SouthWest')      
...
switch  Norm_type
     ...
     case 'L_inf_grad'
        ...
        title('$L^{\infty}(I;H^1(\Omega))$ norm error under $\tau$-refinement with $\theta=3.51$','FontSize',18,'interpreter','LaTex');         
     case 'L_inf_H1'
    ...
    case 'H1_grad'
     ...
     case 'H1_H1'    
        ...
        title('$\|e\|_{\mathrm{E}}$ norm error under $\tau$-refinement with $\theta=3.51$','FontSize',18,'interpreter','LaTex');         
     case 'W_1_inf_L2'
        ylabel('$||e||_{W^{1,\infty}(I;L^2(\Omega))}$','FontSize',18,'interpreter','LaTex');      
        title('$W^{1,\infty}(I;L^2(\Omega))$ norm error under $\tau$-refinement with $\theta=3.51$','FontSize',18,'interpreter','LaTex');  
     case 'H1_inf_grad'
     ...
     case 'Final_t_L2_grad'
        ylabel('$|| \dot{e}(T)||_{H^1(\Omega))}$','FontSize',18,'interpreter','LaTex');        
        title('$|| \dot{e}(T)||_{H^1(\Omega))}$ error under $\tau$-refinement with $\theta=3.51$','FontSize',18,'interpreter','LaTex');            
     case 'Final_t_L2_H1'    
        ylabel('$|| \nabla e(T)||_{L^2(\Omega)}$','FontSize',18,'interpreter','LaTex');        
        title('$|| \nabla e(T)||_{L^2(\Omega)}$ error under $\tau$-refinement with $\theta=3.51$','FontSize',18,'interpreter','LaTex');     
     case 'Final_t_H1_L2'
        ylabel('$|| \dot{e}(T)||_{L^2(\Omega))}$','FontSize',18,'interpreter','LaTex','interpreter','LaTex'); 
        title('$|| \dot{e}(T)||_{L^2(\Omega))}$ error under $\tau$-refinement with $\theta=3.51$','FontSize',18,'interpreter','LaTex');  
     case 'Final_t_H1_grad'
     ...
     case 'Energynorm'    
        ...
        title('DG norm error under $\tau$-refinement with $\theta=3.51$','FontSize',18,'interpreter','LaTex');          
end
