...
NO_time_step_vec = [2,4,8,16,32,64,128];
...
switch  Norm_type
     ...
     case 'L_inf_grad'
        ...
        title('$L^\infty(I;H^1(\Omega))$ norm error for smooth solution under $\tau$-refinement','FontSize',18,'interpreter','LaTex')        
     case 'L_inf_H1'
    ...
    case 'H1_grad'
     ...
     case 'H1_H1'    
        ...
        title('$\|e\|_{\mathrm{E}}$ norm error for smooth solution under $\tau$-refinement','FontSize',18,'interpreter','LaTex')
     case 'W_1_inf_L2'
        ylabel('$||e||_{W^{1,\infty}(I;L^2(\Omega))}$','FontSize',18,'interpreter','LaTex');       
        title('$W^{1,\infty}(I;L^2(\Omega))$ norm error for smooth solution under $\tau$-refinement','FontSize',18,'interpreter','LaTex')   
     case 'H1_inf_grad'
     ...
     case 'Final_t_L2_H1'    
        ...
        title('$||\nabla e(T)||_{L^2(\Omega))}$ for smooth solution under $\tau$-refinement','FontSize',18,'interpreter','LaTex')      
     case 'Final_t_H1_L2'
        ylabel('$||\dot{e}(T)||_{L^2(\Omega))}$','FontSize',18,'interpreter','LaTex');
        title('$||\dot{e}(T)||_{L^2(\Omega))}$ for smooth solution under $\tau$-refinement','FontSize',18,'interpreter','LaTex');
     ...
     case 'Energynorm'    
        ...
        title('DG norm error under for smooth solution $\tau$-refinement','FontSize',18,'interpreter','LaTex')          
end
