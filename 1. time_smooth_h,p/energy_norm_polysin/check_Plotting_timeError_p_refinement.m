...
switch  Norm_type
     ...
     case 'L_inf_grad'
        ...
        title('$L^{\infty}((I;H^1(\Omega))$ norm error under $q$-refinement','FontSize',18,'interpreter','LaTex')        
     case 'L_inf_H1'
    ...
    case 'H1_grad'
     ...
     case 'H1_H1'    
        ...
        title('$\|e\|_{\mathrm{E}}$ norm error under $q$-refinement','FontSize',18,'interpreter','LaTex')
     case 'W_1_inf_L2'
        ylabel('$||e||_{W^{1,\infty}(I;L^2(\Omega))}$','FontSize',25,'interpreter','LaTex');       
        title('$W^{1,\infty}(I;L^2(\Omega))$ norm error under $q$-refinement','FontSize',18,'interpreter','LaTex')   
     case 'W_1_inf_grad'
     ...
     case 'Energynorm'    
        ...
        title('DG norm error under $q$-refinement','FontSize',18,'interpreter','LaTex')         
end
